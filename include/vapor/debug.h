...
#else
#include <sys/time.h>
#define PERF_TIMER_START struct timeval PERF_TIMER_T1, PERF_TIMER_T2;\
...
#define PRINTARGS_1(x, ...) { PRINTARG(x); }
#define PRINTARGS_2(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_1(__VA_ARGS__); }
#define PRINTARGS_3(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_2(__VA_ARGS__); }
#define PRINTARGS_4(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_3(__VA_ARGS__); }
#define PRINTARGS_5(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_4(__VA_ARGS__); }
#define PRINTARGS_6(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_5(__VA_ARGS__); }
#define PRINTARGS_7(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_6(__VA_ARGS__); }
#define PRINTARGS_8(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_7(__VA_ARGS__); }
#define PRINTARGS_9(x, ...) { PRINTARG(x); printf(", "); PRINTARGS_8(__VA_ARGS__); }
...
#define FTRACE(...) do { FTRACE_PRE(); PRINTARGS(__VA_ARGS__); printf(");\n"); } while (0)
