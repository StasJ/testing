...
//! \date    March, 2015
//!
class VDF_API DCHDF5 : public VAPoR::DC {
public:
...
protected:
 ...
 //! Initialize the DCHDF5 class
 //!
 //! Prepare a CF data set for reading. This method prepares
 //! the DCHDF5 class for reading the files indicated by
 //! \p paths.
 ...
 virtual int openVariableRead(
	...
	return(DCHDF5::openVariableRead(ts, varname));
 }
